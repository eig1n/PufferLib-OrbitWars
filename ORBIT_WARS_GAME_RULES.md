...
## 🗺️ 1. Board Layout and Space Geometry

*   **Coordinate Space**: Continuous 2D space of size $100.0 \times 100.0$ units. The coordinate origin $(0, 0)$ is located at the **top-left** corner of the board.
...
2.  **Static Planets**: Planets generated further out (orbital radius plus radius $\ge 50.0$). These planets remain at fixed coordinates for the duration of the episode.
...
*   **max\_speed** is default to $6.0$ units/turn.
*   A fleet with 1 ship travels at $1.0$ unit/turn.
*   A fleet with 500 ships travels at $\approx 5.0$ units/turn.
*   A fleet with 1000 or more ships travels at the maximum speed of $6.0$ units/turn.
...
*   A fleet path from $(x_0, y_0)$ to $(x_1, y_1)$ is treated as a continuous line segment.
