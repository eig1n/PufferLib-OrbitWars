...
Clones/pulls the repository, builds the CUDA backend for drone, runs a short training job for 1 minute, and displays the SPS.
"""
...
run(["bash", "build.sh", "drone"], cwd=REPO_DIR, env=env_vars)
